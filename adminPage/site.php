		...
		<script type="text/javascript">
            ...
            function addMarker(lat, lng, info) {
                ...
                google.maps.event.addDomListener(map, 'tilesloaded', function() {
                    var infoWindowMap = '<a href="site.php?action='+information+'">'+info+'</a>';
                    var popup = new google.maps.InfoWindow({
...
<div>
	 ...
	 if(isset($_SESSION['siteName']))
		...
		echo'<p align="center">Site has been deleted::: Site Name:-<strong>'.$siteName.' </strong></p>';
		}
	...
	<tr><td>District Located:<td>'.$district.'	</tr>
	...
	<tr><td>Site Added By:<td>'.$siteAddedBy.'	</tr>
	

	</table>
	
	<a href="#" style="margin-left:50px;" class="button">EDIT </a> 
	<a href="deleteSite.php" style="margin-left:50px;"class="button" onclick="return myconfirm()">DELETE</a>
'	
;}
