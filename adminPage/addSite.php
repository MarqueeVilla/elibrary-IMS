        ...
        <script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyDY0kkJiTPVd2U7aTOAwhc9ySH6oHxOIYM&sensor=false">
            ...
            function addMarker(lat, lng, info) {
                ...
                var popup = new google.maps.InfoWindow({
                    content: '<a href="site.php?action='+information+'">'+info+'</a>',
                    maxWidth: 600
                });
                
                google.maps.event.addDomListener(map, 'tilesloaded', function() {
                    var infoWindowMap = '<a href=details.php>' + info + '</a>';
                    var popup = new google.maps.InfoWindow({
            ...
            function initMap() {
                map = new google.maps.Map(document.getElementById("map"), {
                    center: new google.maps.LatLng(26, 88),
                    zoom: 5,
...
?>
                ...
                /* for updating latlang and site info on clicked on map */
    ...
    <body onload="">
         <hr>
            ...
            <h4 align="center">Right-Click on a point of the map to get location of that point.</h3>
        <hr>
            

                <div id="map" style="width:500px;height:380px;float:left;margin-left:10px"></div>

                <script type="text/javascript">
                    initMap();
                </script>
				
				<div id="locInfo" style="float:right; margin-right:20px">

				
				<form method="post" action="addloc_db.php" id="inputForm">
				
				<table align="center">
                <h3 align="center">Site Information</h3>
                <tr>
                    <td><label for="name"><strong>Site Name</strong></label></td>
                    <td><input id="name" name="name" type="text" size="55" /></td>
                </tr>
                <tr>
                    <td><label for="lat"><strong>Latitude</strong></label></td>
                    <td><input id="lat" name="lat" type="text" size="55"/></td>
                </tr>
                <tr>
                    <td><label for="lon"><strong>Longitude</strong></label></td>
                    <td><input id="lon" name="lon" type="text" size="55"/></td>
                </tr>
                <tr>
                    <td><label for="organisationName"><strong>Name Of Organisation</strong></label></td>
                    <td><input id="organisationName" name="organisationName" type="text" size="55"/></td>
                </tr>
				<tr>
                    <td><label for="organisationName"><strong>District</strong></label></td>
                    <td>
					<select name="district" class="form-control">
						<?php  
						$rs=mysql_query("SELECT * FROM districtdr ORDER BY district ASC") or die(mysql_error());
						while($row = mysql_fetch_array($rs)) {
			
				
						
						echo "<option value=".$row['district'].">";echo $row['district'];"</option>";
				...
				<table>
                    <td><label for="contactPerson"><strong>Contact Person</strong></label></td>
                    <td><input id="contactPerson" name="contactPerson" type="text" size="55"/></td>
                </tr>
                <tr>
                    <td><label for="contactNumber"><strong>Contact Number</strong></label></td>
                    <td><input id="contactNumber" name="contactNumber" type="text" size="55"/></td>
                </tr>
				<tr>
                    <td><label for="contactEmail"><strong>Email ID</strong></label></td>
                    <td><input id="contactEmail" name="contactEmail" type="text" size="55"/></td>
                </tr>
				<tr>
                    <td><label for="contactNumber"><strong>Designation</strong></label></td>
                    <td><input id="designation" name="designation" type="text" size="55"/></td>
                </tr>
				
				</table>
				<table>
				<h4 align="center">Hardware Specifications</h4>
				<tr>
                    <td><label for="clientNumber"><strong>Number of Clients</strong></label></td>
                    <td><input id="clientNumber" name="clientNumber" type="text" size="55"/></td>
                </tr>
				<tr>
                    <td><label for="serverDist"><strong>Server Distribution</strong></label></td>
                    <td><input id="serverDist" name="serverDist" type="text" size="55"/></td>
                </tr>
